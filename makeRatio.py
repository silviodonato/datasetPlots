...
#        "PromptParking" : ROOT.kGreen+3,
    ...
    hists_num["Prompt"].SetMinimum(0)
    y_max =  hists_num["Prompt"].GetMaximum()
    y_min =   hists_num["Prompt"].GetMinimum()
    x_max =  hists_num["Prompt"].GetXaxis().GetXmax()
    x_min =   hists_num["Prompt"].GetXaxis().GetXmin()
    ...
    hists_num["Prompt"].Draw("L HIST P")
    hists_num["Parking"].Draw("L HIST P same")
    ...
    leg.AddEntry(hists_num["Prompt"], "Prompt", "lp") # or lep or f
